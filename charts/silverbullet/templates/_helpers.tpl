...
*/}}
{{- define "silverbullet.image" -}}
{{- $tag := .Values.image.tag | default .Chart.AppVersion -}}
{{- printf "%s:%s" .Values.image.repository $tag }}
{{- end }}

{{/*
Return the secret name for authentication
*/}}
{{- define "silverbullet.authSecretName" -}}
{{- if .Values.silverbullet.auth.existingSecret }}
{{- .Values.silverbullet.auth.existingSecret }}
{{- else }}
{{- include "silverbullet.fullname" . }}-auth
{{- end }}
{{- end }}
...
Return the PVC name
*/}}
{{- define "silverbullet.pvcName" -}}
{{- if .Values.persistence.existingClaim }}
{{- .Values.persistence.existingClaim }}
{{- else }}
{{- include "silverbullet.fullname" . }}-data
{{- end }}
{{- end }}
